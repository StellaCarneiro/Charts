...
tot <- as.data.frame(table(df.Total$Size.GFIP))

matched <- as.data.frame(table(matched_df$Size.GFIP))
...
ggsave(file="/Users/stellacarneiro/Google Drive/Dissertação - Parte 5/Images/Size_Total_Exporters.pdf", g, width = 4,height = 2.5) 
